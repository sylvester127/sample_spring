...
<div class="container">
   ...
   <b>제목</b>
    ...
    <table align = "center">
      <tr>
        <td>
          <input type="text" id="title" name="title" required minlength="2" maxlength="80" size="100" placeholder="제목을 입력해 주세요">
        </td>
      </tr>
    </table>
    <br>
    ...
    <table align = "center">
      <tr>
        <td>
          <input type="text" id="writer" name="writer" required minlength="2" maxlength="80" size="100" value=${sessionScope.userId} readonly>
        </td>
      </tr>
    </table>
    <br>
    ...
    <table align = "center">
      <tr>
        <td>
          <textarea rows="8" cols="103" id="content" name="content" required minlength="2" maxlength="3000" size="100" placeholder="내용을 입력해 주세요"></textarea>
        </td>
      </tr>
    </table>
    <br>
    ...
    <table id="myTable" border="1" align = "center">
      <tr>
        ...
        <td width="510">
          <span id="custom-text">선택된 파일이 없습니다.</span>
        </td>
        <td>
          <input type="file" id="real-file" name="realfile" hidden="hidden"/>
          <input type="button" id="search-file" name="searchfile" class="searchfile" value="찾아보기..">
        </td>
      </tr>
    ...
    <table>
      <tr>
        <td>
          <input style="float:left; margin-left: 385px" type="button" id="input-file"
                  name="inputfile" class="inputfile" value="파일추가">
        </td>
      </tr>
      <tr>
        <br>
        <input style="float:right; margin-right: 385px" type ="button" id="delete-file"
               name="delete-file" value="파일삭제">
      <br>
        <script>
        var realFileBtn = document.getElementById("real-file");
        var customTxt = document.getElementById("custom-text");
        var searchFileBtn = document.getElementById("search-file");
    ...
    <input id="savebutton" type="submit" value="저장" onClick="func_confirm()">
    <script>
      var savebutton = document.getElementById('savebutton')
        savebutton.addEventListener('click', function func_confirm(){
